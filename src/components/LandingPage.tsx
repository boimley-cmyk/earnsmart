...
const tasks = [
  {
    ...
    description: 'Watch full movies, TV shows, or series episodes assigned to you, then write a structured review covering plot, acting, pacing, and overall experience.',
    image: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800&q=80',
    pay: '$2 – $12',
    payLabel: 'per review',
    tag: 'Beginner Friendly',
    perks: ['Watch on Netflix, Prime & more', 'Full episodes & films', 'No word count limit']
  },
  {
    id: 'translation',
    category: 'Language',
    title: 'Article Translation',
    description: 'Translate news articles, blog posts, product descriptions, or academic content from English into your native language — or vice versa.',
    image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&q=80',
    pay: '$5 – $25',
    payLabel: 'per article',
    tag: 'Bilingual',
    perks: ['50+ supported languages', '300–1500 word articles', 'Flexible deadlines']
  },
  {
    id: 'web3-tasks',
    category: 'Crypto & Web3',
    title: 'Web3 Tasks',
    description: 'Participate in blockchain testnets, mint NFTs, test DeFi protocols, complete on-chain quests, and farm airdrops from early-stage crypto projects.',
    image: 'https://images.unsplash.com/photo-1621761191319-c6fb62004040?w=800&q=80',
    pay: '$3 – $50+',
    payLabel: 'per task',
    tag: 'High Reward',
    perks: ['Airdrop farming', 'Testnet quests', 'NFT minting', 'DeFi protocols']
  },
  {
    id: 'referrals',
    category: 'Passive Income',
    title: 'Referral Program',
    description: 'Share your unique referral link with friends, classmates, or your social media audience. Every person who signs up earns you a commission.',
    image: 'https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=800&q=80',
    pay: '$5 – $15',
    payLabel: 'per referral + 10% ongoing',
    tag: 'Passive',
    perks: ['$5 per signup', '10% ongoing commission', 'Unlimited referrals']
  }
];
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <div className="border-b-2 border-dark py-12 px-6 flex flex-wrap justify-center gap-12 md:gap-24">
        <StatItem number="32" suffix="K+" label="Active Students" />
        <StatItem number="84" prefix="$" suffix="K" label="Paid Out" color="text-brand" />
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 items-start relative z-10">
          ...
          <div className="bg-white border-2 border-dark rounded-3xl p-12 brutal-shadow relative overflow-hidden">
            ...
            <div className="font-display text-7xl text-dark tracking-tighter mb-12">
              $84,240<span className="text-brand">.50</span>
            </div>
      ...
      <section id="join" className="py-24 px-6 text-center bg-brand border-t-2 border-dark">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-dark text-2xl mb-16 font-bold">Join 32,000+ students already earning with EARNSMART. Free to join, free to withdraw.</p>
...
function StatItem({ number, prefix = '', suffix = '', label, color = 'text-dark' }: { number: string, prefix?: string, suffix?: string, label: string, color?: string }) {
  return (
    <div className="text-center">
      <div className={`font-display text-5xl md:text-7xl tracking-tighter ${color}`}>
        {prefix}{number}{suffix}
      </div>
      <div className="text-gray-500 text-sm font-bold uppercase tracking-widest mt-2">{label}</div>
    </div>
  );
}
