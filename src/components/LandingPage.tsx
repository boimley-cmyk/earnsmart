  ...
  return (
    <div className="min-h-screen pt-20 bg-grid">
      ...
      <section className="py-24 px-6 text-center max-w-6xl mx-auto relative overflow-hidden">
        ...
        >
          <Link to={isAuthenticated ? "/dashboard" : "/signup"} className="bg-dark text-white px-12 py-5 rounded-full font-bold text-xl uppercase tracking-wider hover:bg-brand hover:text-dark transition-all brutal-shadow-hover">
      ...
      <section id="join" className="py-24 px-6 text-center bg-brand border-t-2 border-dark">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
            ...
            <Link to={isAuthenticated ? "/dashboard" : "/signup"} className="bg-dark text-white px-12 py-5 rounded-full font-bold text-xl uppercase tracking-wider hover:bg-white hover:text-dark transition-all brutal-shadow-hover flex-1">
