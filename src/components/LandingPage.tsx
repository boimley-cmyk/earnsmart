  ...
  return (
    <div className="min-h-screen pt-20 bg-grid">
      ...
      <section className="py-24 px-6 text-center max-w-6xl mx-auto relative overflow-hidden">
        ...
        >
          The professional micro-task platform for students. Review content, assist with translations, and support Web3 research — all on your own schedule.
        </motion.p>
        ...
        >
          <Link to={isAuthenticated ? "/dashboard" : "/signup"} className="bg-dark text-white px-10 py-4 rounded-full font-bold text-lg uppercase tracking-wider hover:bg-brand hover:text-dark transition-all brutal-shadow-hover">
            {isAuthenticated ? 'Go to Dashboard' : 'Get Started'}
          </Link>
          <a href="#how" className="border-2 border-dark px-10 py-4 rounded-full font-bold text-lg uppercase tracking-wider hover:bg-gray-50 transition-all">
            How it works
          </a>
        </motion.div>
      </section>
      ...
      {/* Trust Section */}
      <section className="py-12 border-y-2 border-dark bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400 mb-8">Trusted by students from top institutions</p>
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-40 grayscale">
            <span className="font-display text-2xl md:text-3xl tracking-tighter">OXFORD</span>
            <span className="font-display text-2xl md:text-3xl tracking-tighter">CAMBRIDGE</span>
            <span className="font-display text-2xl md:text-3xl tracking-tighter">STANFORD</span>
            <span className="font-display text-2xl md:text-3xl tracking-tighter">MIT</span>
            <span className="font-display text-2xl md:text-3xl tracking-tighter">HARVARD</span>
          </div>
        </div>
      </section>
      ...
      <section id="join" className="py-24 px-6 text-center bg-brand border-t-2 border-dark">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-dark text-2xl mb-16 font-bold">Join thousands of students already building their professional portfolio with EARNIE.</p>
