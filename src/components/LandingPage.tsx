...
const tasks = [
  {
    ...
    description: 'Help train the next generation of AI models. Provide high-quality feedback on AI responses and assist with RLHF (Reinforcement Learning from Human Feedback).',
    image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&q=80',
    pay: '$21.00',
    payLabel: 'per hour',
    tag: 'High Payout',
    perks: ['Flexible Hours', 'No Experience Needed', 'Weekly Payouts']
  },
  {
    id: 'movie-reviews',
