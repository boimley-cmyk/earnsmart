    ...
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row pt-16 lg:pt-20 pb-24 lg:pb-0">
      ...
      <aside className="w-72 bg-white border-r-2 border-dark hidden lg:flex flex-col p-8 sticky top-20 h-[calc(100vh-80px)]">
        ...
        <div className="bg-brand border-2 border-dark p-8 rounded-3xl brutal-shadow">
          ...
          <p className="text-sm text-dark font-bold mb-6 uppercase leading-tight">Complete 5 more tasks to unlock $5.00 bonus!</p>
          <div className="w-full bg-white border-2 border-dark h-4 rounded-full overflow-hidden">
            <div className="bg-dark h-full w-[60%]" />
          </div>
        </div>
      </aside>
      ...
      <main className="flex-1 p-6 md:p-8 lg:p-16 bg-grid">
        <header className="mb-10 lg:mb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-500 font-bold uppercase text-[10px] md:text-xs tracking-widest mt-2">Here's what's happening with your earnings today.</p>
          </div>
          <div className="flex gap-3 md:gap-4">
            <button className="flex-1 md:flex-none bg-white border-2 border-dark text-dark font-bold uppercase tracking-widest px-6 md:px-8 py-3 rounded-full hover:bg-gray-50 transition-all text-xs md:text-sm">
              History
            </button>
            <button className="flex-1 md:flex-none bg-dark text-white font-bold uppercase tracking-widest px-6 md:px-8 py-3 rounded-full shadow-lg hover:bg-brand hover:text-dark transition-all brutal-shadow-hover flex items-center justify-center gap-2 text-xs md:text-sm">
              <Wallet size={18} />
              Withdraw
            </button>
          </div>
          ...
          <div className="bg-brand border-2 border-dark rounded-3xl p-6 md:p-8 brutal-shadow flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center justify-between md:justify-end gap-6 w-full md:w-auto border-t-2 md:border-t-0 border-dark/10 pt-6 md:pt-0">
              ...
              <button 
                ...
                className="bg-dark text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-bold uppercase tracking-widest hover:bg-white hover:text-dark transition-all brutal-shadow-hover text-xs md:text-sm"
              >
                Resume Task
              </button>
            </div>
