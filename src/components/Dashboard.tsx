...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex pt-20">
      ...
      {/* Main Content */}
      <main className="flex-1 p-8 lg:p-16 bg-grid">
        ...
        {/* Active Task (Mock) */}
        <div className="mb-12">
          <div className="bg-brand border-2 border-dark rounded-3xl p-8 brutal-shadow flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              <div className="w-16 h-16 bg-white border-2 border-dark rounded-2xl flex items-center justify-center animate-pulse">
                <PlayCircle size={32} className="text-dark" />
              </div>
              <div>
                <div className="text-xs font-bold uppercase tracking-[0.2em] text-dark/60 mb-1">Active Task</div>
                <h3 className="font-display text-3xl uppercase tracking-tighter text-dark">Movie Review: Dune Part Two</h3>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="text-right hidden md:block">
                <div className="text-xs font-bold uppercase tracking-widest text-dark/60">Progress</div>
                <div className="text-sm font-bold text-dark">45% Complete</div>
              </div>
              <button 
                onClick={() => navigate('/task/movie-reviews')}
                className="bg-dark text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest hover:bg-white hover:text-dark transition-all brutal-shadow-hover"
              >
                Resume Task
              </button>
            </div>
