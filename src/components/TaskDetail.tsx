                      ...
                      <div className="space-y-6 md:space-y-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                          ...
                          <button 
                            ...
                            className="w-full bg-dark text-white py-4 md:py-5 rounded-full font-bold text-lg md:text-xl uppercase tracking-wider hover:bg-brand hover:text-dark transition-all brutal-shadow-hover flex items-center justify-center gap-3"
                          >
                            {isSubmitting ? (
                              <>
              ...
              <div className="bg-white border-2 border-dark p-6 md:p-8 rounded-3xl brutal-shadow md:sticky md:top-32">
                ...
                {!isStarted ? (
                  <button 
                    ...
                    className="w-full bg-dark text-white py-4 md:py-5 rounded-full font-bold text-lg md:text-xl uppercase tracking-wider hover:bg-brand hover:text-dark transition-all brutal-shadow-hover"
                  >
                ...
                <p className="text-center text-[10px] text-gray-400 font-bold uppercase mt-4">Takes less than 2 minutes</p>
              </div>
            </div>
          </div>
        </div>
        {/* Signup CTA */}
        <div className="mt-16 md:mt-20 bg-brand border-2 border-dark rounded-3xl p-8 md:p-12 text-center brutal-shadow">
          <h2 className="font-display text-3xl md:text-4xl uppercase tracking-tighter mb-4 md:mb-6 leading-tight">Ready to start this task?</h2>
          <p className="text-dark font-bold mb-8 md:mb-10 uppercase tracking-tight text-xs md:text-base">Join 14,000+ students earning today. Free to join, instant payouts.</p>
          <Link 
            to="/signup" 
            className="inline-block bg-dark text-white px-8 md:px-12 py-4 md:py-5 rounded-full font-bold text-lg md:text-xl uppercase tracking-wider hover:bg-white hover:text-dark transition-all brutal-shadow-hover w-full sm:w-auto"
          >
