      ...
      <div className="max-w-5xl mx-auto">
        ...
        {!isAuthenticated && (
          <div className="mt-16 md:mt-20 bg-brand border-2 border-dark rounded-3xl p-8 md:p-12 text-center brutal-shadow">
            ...
            <p className="text-dark font-bold mb-8 md:mb-10 uppercase tracking-tight text-xs md:text-base">Join our community of student professionals. Verified assignments, secure payments.</p>
            <Link 
              to="/signup" 
