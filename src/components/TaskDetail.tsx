    ...
    <div className="min-h-screen pt-20 md:pt-24 pb-20 px-4 md:px-6 bg-grid">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-16 md:mt-20 bg-brand border-2 border-dark rounded-3xl p-8 md:p-12 text-center brutal-shadow">
          ...
          <Link 
            to="/signup" 
            className="inline-block bg-dark text-white px-8 md:px-10 py-3.5 md:py-4 rounded-full font-bold text-lg md:text-xl uppercase tracking-wider hover:bg-white hover:text-dark transition-all brutal-shadow-hover w-full sm:w-auto"
          >
