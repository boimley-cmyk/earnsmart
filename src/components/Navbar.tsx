      ...
      <div className="flex items-center gap-10">
        ...
        {isAuthenticated ? (
          <div className="flex items-center gap-6">
            <Link to="/dashboard" className="bg-dark text-white px-8 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-brand hover:text-dark transition-all brutal-shadow-hover">
              Dashboard
            </Link>
            <button 
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to="/signup" className="bg-dark text-white px-8 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-brand hover:text-dark transition-all brutal-shadow-hover">
              Sign Up
            </Link>
          </div>
        )}
